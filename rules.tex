            ...
            \item If he won a battle against another player:
                ...
                \begin{itemize}
                    \item steps \ref{expand1} and \ref{expand3}:
                        the player can discard cards but not set aside new cards;
                        instead he can exchange any number of his set-aside cards
                        with cards from his hand.
                    \item step \ref{expand2}:
                        ...
                        and does not give the right use step \ref{expand5} again
