...
\section{Main phase}
  ...
  \subsection{Beginning}
  	...
  	\begin{itemize}
        \item Place 2 counters on each Portal territory.
...
\newpage
  \subsection{Production capacities}
    \hspace{-2em}Each territory has a given \textbf{\textit{production capacity}} for
    each type of resource.
    \vspace{-1.3em}
    \begin{description}
        \item[Potal territory] \hfill \\
        2 in the valuable resource of their civilization
        and 1 in every other type of resource,
        \item[Normal territory] \hfill \\
        2 in the resource of their color and 1 in every
        other type of resource,
        \item[Heart of Eden] \hfill \\
        can be seen by any player as having 2 in their valuable
        resource and 1 in every other resource type,
        \item[Other] \hfill \\
        Territories outside of the map are considered as having a
        production capacity of 1 in every type of resource.
        That is to say, if a unit card is played on a tile on the border
  ...
  \subsection{Managing one's territory}
    \hspace{-2em}Once per turn, a player can manage the territories he controls:
    \vspace{-1.3em}
    \begin{description}
        \item[Portal territory] \hfill \\
        	Nothing can be done on this territory.
        \item[Normal territory] \hfill \\
        	For each normal territory, he may choose to either:
            \vspace{-0.7em}
            \begin{itemize}
        		\item produce: he chooses a type of resource and then puts
            	on the territory as many new resource tokens of that type that its
        ...
        \item[Heart of Eden] \hfill \\
            ...
            \vspace{-0.7em}
            \begin{itemize}
        		\item produce: he puts 2 counters on his Portal territory,
                while other players put 1 on theirs.
                He may then remove any number of counters from his Portal territory
                to put as many new resource tokens (of any combination of types)
                on the Heart of Eden,
        		\item destroy resources: same thing: he removes half of the resource
                tokens of each type of resource on the territory (rounded up),
        		\item do nothing.
    		\end{itemize}
    \end{description}
...
\subsection{Making a breakthrough}
    ...
    \hspace{-2em} To make a breakthrough, the player:
    \vspace{-1.3em}
    \begin{enumerate}
        \item replenishes his hand to 5 cards,
        \item selects any number of frontiers on those conquered territories 
        (possibly none),
    ...
    (and last) breakthrough from his newly conquerred territories and go back
    to step 1 instead of going to step 4.
    }
...
\newpage
  ...
  \subsection{Technical terms}
    ...
    \begin{description}
        ...
        (of any kind) besides your units of a front
        (your \textit{\textbf{mana reserve}} on this front).\\
