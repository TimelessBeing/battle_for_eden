...
\newpage
  \subsection{Managing one's territories}
    ...
    \vspace{-1em}
      \hspace{-2em} Resource production works differently depending on the territory involved:
      \vspace{-1.3em}
      \begin{description}
          ...
          The player adds an amount of 2 in counters on his Portal territory,
          and each other player adds an amount of 1 in counters on their Portal territories.
